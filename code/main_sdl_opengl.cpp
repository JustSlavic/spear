...
void draw_debug_graph(debug_graph *graph, gpu_mesh *m, shader *s)
{
    transform tm_ui = transform::translate(-1.f, -1.f, 0.f)
                    * transform::scale(2.f / current_client_width,
                                       2.f / current_client_height,
                                       1.f);
    int32 frame_posy = 100;
    int32 frame_height = 200;
    int32 frame_width = current_client_width;
    // Draw frame for debug graph
    {
        int32 width[4] = { 1, 1, frame_width, frame_width };
        int32 height[4] = { frame_height, frame_height, 1, 1 };
        int32 posx[4] = { 0, frame_width - 1, 0, 0 };
        int32 posy[4] = { frame_posy, frame_posy, frame_posy, frame_posy + frame_height };
