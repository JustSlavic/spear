...
SET WARNINGS=/W4 /WX /wd4201 /wd4100 /wd4189 /wd4505 /wd4702 /wd4305 /wd4244 /wd4018 /D_CRT_SECURE_NO_WARNINGS
SET DEFINES=/DDEBUG=1 /DDLL_BUILD=0
SET INCLUDES=/Icode
...
rem cl %MSVC_FLAGS% %WARNINGS% %DEFINES% %INCLUDES% /Febin/spear_game /Tccode/game_rpg/game.c /LD /link /PDB:%PDB_FILENAME% %LINKER_FLAGS%
